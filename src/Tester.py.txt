...
def test4():
    input_to_test = """\
T4,DL,R2x3,DL,O2,N,N,O1,V5,O2,T3"""
...
def test6():
    ...
    input_to_test = """\
T4,S4,DL,DL,T5,N,E1x4,R3x5,E1x7,T3,E1x4,N,B,N,DL,V3,V15,T7,S3,R5x2"""
...
if __name__ == "__main__":
    ...
    runtest(executable_file, test4())
    runtest(executable_file, test5())
    runtest(executable_file, test6())
